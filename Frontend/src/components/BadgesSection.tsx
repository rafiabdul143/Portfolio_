...
// Example badge data
const badges = [
    { img: Fabric, link: "https://learn.microsoft.com/api/credentials/share/en-us/Abdul1Rafi/D7500F731B21916C?sharingId=F405F5CEA2FEC3B5", name: "DP-700 Fabric ", issuer: "Microsoft" },
